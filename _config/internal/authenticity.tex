...
\newcommand*{\setSigLocation}[1]{\def\@location{#1}}
\newcommand*{\setSigSubmissiondate}[1]{\DTMsavedate{submissiondate}{#1}\DTMmakeglobal{submissiondate}}
...
\def\@signarea{\def\lw{1.1pt}%
	...
	\begin{minipage}[b]{.5\textwidth-5mm}
		\begin{tikzpicture}
			...
			\@ifundefined{@signature}{}{\node[content,sigshift, yshift=\lw/2+3.5pt] at (0,0) {\Large \@ifundefined{@location}{Ulm}{\@location} \quad \DTMifsaveddate{submissiondate}{\DTMusedate{submissiondate}}{\DTMtoday}};}
		\end{tikzpicture}
	\end{minipage}\hfill
	\begin{minipage}[b]{.5\textwidth-5mm}
		\begin{tikzpicture}
