\makeatletter
\RequirePackage[vlined,algochapter,tworuled,linesnumbered]{algorithm2e}
\RequirePackage{float,newfloat}
...
\addto\captionsngerman{\def\pseudoname{Algorithmus}\def\pseudoautorefname{\pseudoname}}
\addto\captionsenglish{\def\pseudoname{Algorithm}\def\pseudoautorefname{\pseudoname}}
...
% \def\DataflowProcessorOut{\Output{environment~\(E\), graph~\(G\), in-, outgoing, and unknown references~\(I\),\,\(O\)\,\&\,\(U\)}}
\SetArgSty{}
