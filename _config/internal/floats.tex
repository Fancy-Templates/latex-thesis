...
\InitPageCounter{figure}\InitPageCounter{table}
...
\def\HookCount#1#2{\pretocmd\scr@caption{#2}\relax\relax}%
...
\AtBeginEnvironment{longtable}{\HookCount{lot}{\thesissettbl}}
...
\def\@@formatcounter#1#2{%
  \smash{\textit{\figureversion{lf}% use lining figures for references
    #1}%
    %/
...
% TODO: ref subfigure more conventional?
% \renewcommand\thesubfigure{\@formatcounter f{\c@figure@lb}\alph{subfigure}}

% \def\thesubfigure{\@formatcounter s{\c@figure@lb/\alph{subfigure}}}
% \def\theexa{\@formatcounter e{\c@exa@lb}}
% \def\thents{\@formatcounter n{\c@nts@lb}}
