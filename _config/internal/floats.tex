...
\def\HookLstCount#1#2{\HookCountBare{#1}{#2}\lst@MakeCaption}
...
\AtBeginEnvironment{lstlisting}{\HookLstCount{lol}{\thesissetlst}}
\AtBeginEnvironment{minted}{\HookLstCount{lol}{\thesissetlst}}
\fi
...
\AddToHook{begindocument/end}{\def\thelstlisting{\@formatcounter l{\c@lstlisting@lb}}}
\fi
